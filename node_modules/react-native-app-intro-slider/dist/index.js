...
class AppIntroSlider extends React.Component {
    constructor() {
        ...
        this._renderNextButton = () => this.props.showNextButton &&
            this._renderButton('', this.props.nextLabel, () => this.goToSlide(this.state.activeIndex + 1, true), this.props.renderNextButton);
        ...
        this._renderDoneButton = () => this.props.showDoneButton &&
            this._renderButton('', this.props.doneLabel, this.props.onDone, this.props.renderDoneButton);
